    ...
    const handleSmoothScroll = (e, targetId) => {
        ...
        if (targetElement) {
            targetElement.scrollIntoView({
                ...
                block: 'start' // Hedef elementin başlangıcına kaydır
            });
        }
    };
    ...
    return (
        <div>
            {icons.map((icon, index) => (
                <a
                    href={icon.link} // Linki buraya ekliyoruz
                    onClick={(e) => handleSmoothScroll(e, icon.link)} // Smooth scroll için handler
