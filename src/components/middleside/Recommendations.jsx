...
const Recommendations = () => {
    return (
        <div className='grid grid-cols-1 justify-items-start md:justify-items-center font-inter font-normal text-[14.23px] text-third'>
            <h2 className='text-primary dark:text-white  font-bold text-[30.35px]'>Recommendations</h2>
