...
const Slider = () => {
  return (
    <div className='grid grid-cols-2 w-[920.07px] h-[442.96px] bg-white ml-[28.46px] mr-[25.61px]'>
      <div className='font-inter w-[502.73px] mt-[88.21px] ml-[56.91px]'>
        <h2 className='font-bold text-[45.53px] text-primary'>I’m Rayan Adlrdard</h2>
        <h2 className='font-bold text-[45.53px] text-primary'><span className='text-secondary'>Front-end</span> Developer </h2>
        ...
        <button className='flex justify-center items-center bg-secondary w-[146.07px] h-[48.35px] rounded font-inter font-medium text-[15.18px] text-primary mt-6 '>HIRE ME
