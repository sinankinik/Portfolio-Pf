...
const MyServices = () => {
    ...
    const items = [
        { src: web, alt: 'web', link: '/', caption: t('web_development'), text: t('blog'), w: "62.48px", h: "50.39px" },
        { src: uiux, alt: 'uiux', link: '/', caption: t('ui_ux'), text: t('mobile'), w: "64.5px", h: "63.37px" },
    ...
    return (
        <div className='grid grid-cols-1 justify-items-start md:justify-items-center font-inter mt-[130.81px] font-normal text-[14.23px] text-third'>
            <h2 className='text-primary dark:text-white  font-bold text-[30.35px]'>{t('my_services')}</h2>
