...
const PricePlans = () => {
    ...
    return (
        <div className='grid grid-cols-1 justify-items-center font-inter mt-[66.4px] font-normal text-[14.23px] text-third mb-[66.4px]'>
            <h2 className='text-primary font-bold text-[30.35px]'>Price Plans</h2>
            ...
            <div className='grid grid-cols-3 gap-x-[19.92px]'>
                <div className='bg-white w-[294.04px] h-[577.65px] font-inter font-normal text-third text-[14.23px] pt-[51.22px] mt-[47.43px]'>
                    <h2 className='font-semibold text-primary ml-[115.72px]'>Silver</h2>
                ...
                <div className='bg-white w-[294.04px] h-[577.65px] font-inter font-normal text-third text-[14.23px] mt-[47.43px]'>
                    <div className='bg-secondary flex items-center justify-center w-full h-[28.46px] mb-[22.76px]'>
                        <h2 className='text-primary'>Most Popular</h2>
                    </div>
                    <h2 className='font-semibold text-primary ml-[115.72px]'>Gold</h2>
                    <div className='flex items-center text-primary'>
                ...
                <div className='bg-white w-[294.04px] h-[577.65px] font-inter font-normal text-third text-[14.23px] pt-[51.22px] mt-[47.43px]'>
                    <h2 className='font-semibold text-primary ml-[115.72px]'>Diamond</h2>
                    <div className='flex items-center text-primary'>
